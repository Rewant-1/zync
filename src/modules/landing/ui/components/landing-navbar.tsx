            ...
            <div className="hidden md:flex items-center gap-2">
              <SignedOut>
                ...
                <SignUpButton mode="modal">
                  <Button 
                    size="sm" 
                    className="bg-gradient-to-r from-[#b96aff] to-[#00fff0] text-black hover:from-[#00fff0] hover:to-[#b96aff] shadow-lg shadow-[#b96aff]/40 hover:shadow-[#00fff0]/60 transition-all duration-300 font-semibold px-3 py-1 rounded-lg text-xs"
                  >
            ...
            <div className="px-4 py-4 space-y-3">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="block px-3 py-2 rounded-lg text-neutral-400 hover:text-[#b96aff] hover:bg-[#1a1a1a] transition-all duration-300 border border-transparent hover:border-[rgba(186,85,255,0.12)] text-sm"
              ...
              <div className="pt-3 border-t border-[rgba(186,85,255,0.12)] space-y-2">
                <SignedOut>
                  ...
                  <SignUpButton mode="modal">
                    <Button 
                      size="sm" 
                      className="w-full bg-gradient-to-r from-[#b96aff] to-[#00fff0] text-black hover:from-[#00fff0] hover:to-[#b96aff] shadow-lg shadow-[#b96aff]/40 hover:shadow-[#00fff0]/60 transition-all duration-300 font-semibold text-sm"
                    >
