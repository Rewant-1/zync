				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 relative">
					{plans.map((plan, index) => {
						...
						return (
							...
							>
								<Card
									className={`h-full min-h-[600px] flex flex-col border-0 shadow-2xl hover:shadow-lg transition-all duration-300 bg-white/90 dark:bg-background/90 backdrop-blur-sm group-hover:border group-hover:border-amber-400/50 group-hover:bg-white/95 dark:group-hover:bg-background/95 relative overflow-hidden ${
										isPopular
								...
								>
									{isPopular && (
										<div className="absolute -inset-1 rounded-2xl pointer-events-none opacity-80 transition-opacity duration-300 bg-gradient-to-r from-cyan-400/10 via-amber-300/15 to-cyan-400/10 blur-md" />
									)}
